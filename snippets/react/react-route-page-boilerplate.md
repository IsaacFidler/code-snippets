---
Title: Route-Level Page Boilerplate
Description: Template for a new top-level route page - Page wrapper, responsive header, selector-derived data, and explicit loading/error states (not a blank return-null while loading)
Tags:
  - react
  - rtk-query
  - mui
