---
Title: ICE Feature/Leaf Component Boilerplate
Description: ICE-pattern template for a smaller feature-level component - self-fetches its own data via RTK Query + a selector, and uses a real discriminated union for either-or props instead of an unused one
Tags:
  - ice
  - react
  - rtk-query
